...
const IconBrandAdobePremier = createReactComponent("outline", "brand-adobe-premier", "BrandAdobePremier", __iconNode);

export { __iconNode, IconBrandAdobePremier as default };
