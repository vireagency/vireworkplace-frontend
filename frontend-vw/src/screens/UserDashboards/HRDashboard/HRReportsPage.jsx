...
import { Search, Filter, Eye, Download, Plus, BarChart3, Users, AlertTriangle, FileText, MessageSquare, X } from "lucide-react"
...
const myReportsData = [
  ...
  {
    id: 3,
    report: "Workplace Safety Incident - January",
    type: "Incident",
  ...
  {
    id: 4,
    report: "Employee Satisfaction Survey Results",
    type: "General",
    typeIcon: FileText,
    department: "Human Resources",
    priority: "low",
  ...
  {
    id: 5,
    report: "Training Program Effectiveness",
    type: "Performance",
    typeIcon: BarChart3,
    department: "Human Resources",
    priority: "medium",
...
const employeeReportsData = [
  {
    id: 1,
    report: "Monthly Progress Report - Engineering",
    type: "General",
    typeIcon: FileText,
  ...
  {
    id: 2,
    report: "Customer Support Metrics",
    type: "Performance",
    typeIcon: BarChart3,
...
const overtimeReportsData = [
  ...
  },
  {
    ...
    overtimeHours: "3h",
    totalHours: "11h",
    reason: "Equipment maintenance during non-...",
    manager: "Mike Chen"
  },
  {
    id: 3,
    ...
    overtimeHours: "2h",
    totalHours: "10h",
    reason: "Handling urgent customer escalation",
  ...
  },
  {
    ...
    overtimeHours: "5h",
    totalHours: "13h",
    reason: "Month-end financial reporting deadli...",
    manager: "Lisa Brown"
  },
  {
    id: 5,
  ...
  },
  {
    ...
    overtimeHours: "6h",
    totalHours: "14h",
    reason: "System upgrade and migration",
    manager: "Mike Chen"
  }
]
...
export default function HRReportsPage() {
  ...
  // Safe icon renderer
  const renderIcon = (IconComponent, className = "w-4 h-4 text-gray-400 mr-2") => {
  ...
  const filteredReports = getCurrentData().filter(report => {
    if (activeTab === "overtime-reports") {
      ...
      const matchesSearch = report.employeeId.toLowerCase().includes(searchQuery.toLowerCase()) ||
        ...
        <div className="pb-4">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage and track all HR reports.</p>
            </div>
            <Button 
                ...
                {myReportsSummaryCards.map((card, index) => (
                  <Card key={index} className="@container/card relative">
                    ...
                    <div className="absolute bottom-3 right-3">
                      <Badge variant="secondary" className={card.color === "green" ? "text-green-600 bg-green-50" : "text-red-600 bg-red-50"}>
                        {renderIcon(card.icon, card.color === "green" ? "text-green-600" : "text-red-600")}
                        {card.change}
                      </Badge>
                    </div>
                  </Card>
                        ...
                        return (
                          <TableRow key={report.id} className="hover:bg-gray-50">
                            <TableCell className="py-4 px-4">
                              <div className="text-sm font-medium text-gray-900">{report.report}</div>
                            </TableCell>
                            <TableCell className="py-4 px-4">
                            ...
                            <TableCell className="py-4 px-4">
                              <span className="text-sm text-gray-900">{report.department}</span>
                            </TableCell>
                            <TableCell className="py-4 px-4">
                            ...
                            <TableCell className="py-4 px-4">
                              <span className="text-sm text-gray-900">{report.created}</span>
                            </TableCell>
                            <TableCell className="py-4 px-4">
          ...
          <TabsContent value="employee-reports" className="mt-8">
            ...
            <div className="mt-6">
              <div className="bg-white rounded-lg border p-6">
                ...
                <div className="mb-6">
                  <div className="mb-2">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Reports from Employees</h3>
                    <div className="flex items-center gap-64">
          ...
          <TabsContent value="overtime-reports" className="mt-8">
            ...
            <div className="mt-6">
              <div className="bg-white rounded-lg border p-6">
                ...
                <div className="mb-6">
                  <div className="mb-2">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Employee Overtime Reports</h3>
                    <div className="flex items-center gap-64">
                      <p className="text-sm text-gray-500">6 overtime records</p>
                    </div>
                  </div>
                </div>
                        ...
                        <TableRow key={report.id} className="hover:bg-gray-50">
                          ...
                          <TableCell className="py-4 px-4">
                            <div className="flex items-center">
                              ...
                              <span className="text-sm text-gray-900">{report.regularHours}</span>
                            </div>
                          </TableCell>
                          <TableCell className="py-4 px-4">
                            <div className="flex items-center">
                              ...
                              <span className="text-sm text-orange-500 font-medium">{report.overtimeHours}</span>
                            </div>
                          </TableCell>
                          <TableCell className="py-4 px-4">
                            <span className="text-sm text-gray-900">{report.totalHours}</span>
                          </TableCell>
                          <TableCell className="py-4 px-4">
                            <span className="text-sm text-gray-900">{report.reason}</span>
                          </TableCell>
                          <TableCell className="py-4 px-4">
                            <span className="text-sm text-gray-900">{report.manager}</span>
                          </TableCell>
                          <TableCell className="py-4 px-4">
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-600">
              Fill in the details below to create a new report. All fields marked with * are required.
            </DialogDescription>
          </DialogHeader>
