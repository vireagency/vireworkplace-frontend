      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="mb-8 ml-6">
          ...
          <p className="text-zinc-500">
            Manage and monitor employee information across the organization.
          </p>
        </div>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem
                                ...
                                onClick={(e) => {
                                  ...
                                  e.stopPropagation();
                                  console.log(
                                    "Edit Profile clicked for employee:",
                                    employee.id
                                  );
                                  ...
                                  setTimeout(() => {
                                    console.log(
                                      "Navigating to edit employee profile"
                                    );
                                    // Add navigation logic here when edit functionality is implemented
                                    // navigate(`/human-resource-manager/employees/${employee.id}/edit`);
                                  }, 100);
                                }}
                              >
                              ...
                              <DropdownMenuItem
                                ...
                                onClick={(e) => {
                                  ...
                                  setTimeout(() => {
                                    console.log(
                                      "Navigating to view employee details"
                                    );
                                    // Add navigation logic here when view functionality is implemented
                                    // navigate(`/human-resource-manager/employees/${employee.id}`);
                                  }, 100);
                                }}
                              >
                              ...
                              <DropdownMenuItem
                                ...
                                onClick={(e) => {
                                  ...
                                  e.stopPropagation();
                                  console.log(
                                    "Send Message clicked for employee:",
                                    employee.id
                                  );
                                  ...
                                  setTimeout(() => {
                                    console.log(
                                      "Navigating to send message to employee"
                                    );
                                    // Add navigation logic here when messaging functionality is implemented
                                    // navigate(`/human-resource-manager/messages?to=${employee.id}`);
                                  }, 100);
                                }}
                              >
                                Send Message
