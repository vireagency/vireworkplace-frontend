...
const UniformSidebar = ({
  ...
  // Initialize expanded sections with stable state
  useEffect(() => {
    ...
    setExpandedSections((prev) => {
      ...
      const hasChanged = Object.keys(initialExpanded).some(
        (key) => prev[key] !== initialExpanded[key]
      );
      return hasChanged ? initialExpanded : prev;
    });
    ...
    (item, sectionKey) => {
      ...
      return (
        ...
        >
          ...
          {isNavigating && location.pathname !== item.url && (
  ...
  const renderSection = useCallback(
    ...
    [expandedSections, toggleSection, isNavigating, isLoading, renderNavItem]
  );
